          ...
          <div className=' muahang_info' >
            <h1 className='muahang_info_name'>{name}</h1>
              <div className=' muahang_info_item my-2'>
                <div className='muahang_info_item_price '>
                  <div className=''>{price_millions}.{price_thousand}00.000 ₫</div>
                </div>
                <div className=''>
                  <div className='muahang_info_line'></div>
                </div>
                <div className='muahang_info_item_id'>
                  <div className='muahang_info_item_id_1'>
                    <span>Kho hàng: </span>
                    <span className='muahang_info_item_id_1_span'>{slot}</span>
                  </div>
                  <div>
                    <span className='muahang_info_item_id_2'>Mã sản phẩm: 
                      <span className='muahang_info_item_id_2_code'>{code}</span>
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className='muahang_info_buy'>
              ...
              <div className='muahang_info_phone'>
                <div className='size center green h-100 phone'>
                  ...
                  <span className='phone_text'>Gọi điện</span> 
                </div>
              </div>
            </div>
          </div>
        ...
        <div className='policy_shop border'>
          <div className=' policy_shop_detail'>
            <div className=' policy_shop_icon'><RiVipDiamondLine/></div>
              <div className='policy_shop_text'>Hàng chính hãng, chất lượng hàng đầu.</div>
            </div>
            <div className=' policy_shop_detail mx-2'>
              <div className=' policy_shop_icon'><FaShippingFast/></div>
              <div className='policy_shop_text'>Miễn phí giao hàng với đơn {"<"}500k</div>
            </div>
            <div className=' policy_shop_detail'>
              <div className='policy_shop_icon '><RiRefund2Line/></div>
              <div className='policy_shop_text'>Đổi hàng 30 ngày với thủ tục đơn giản</div>
            </div>
          </div>
        </div>
    )
