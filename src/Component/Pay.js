              ...
              <div className="col-12 pay_info_main">
                ...
                <div className='pay_info_4 center chu'>
                  ...
                  <div className="pay_info_4_info">{item.slot}</div>
                    <div className='pay_info_4_arrow '>
                      <div className='' onClick={()=>upp(index)}>
                        <IoIosArrowForward/>
                      </div>
                    </div>
                  </div>
              
                  <div className="pay_info_5 center chu">
                      <span><Money price={item.slot*item.price}/></span>
                  </div>
                  <div className="bin center chu" onClick={()=>DeleteSp(item)}>
